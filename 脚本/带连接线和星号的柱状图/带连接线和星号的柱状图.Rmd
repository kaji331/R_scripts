...
#画星星
x.text <- colMeans(as.matrix(p$xvals[1,1:2])) ##1决定哪些分组需要画星星
y.text <- apply(as.matrix(p$CI[2,1:2,1]),2,max)+3 ##1决定哪些分组需要画星星
text("**",x=x.text,y=y.text)
```
