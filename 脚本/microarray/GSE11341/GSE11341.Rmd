...
y_up <- geneAnswersBuilder(humanGeneInput_up,"org.Hs.eg.db",categoryType="KEGG",testType="hyperG",pvalueT=0.1,geneExpressionProfile=humanExpr_up,verbose=F)
...
y_down <- geneAnswersBuilder(humanGeneInput_down,"org.Hs.eg.db",categoryType="KEGG",testType="hyperG",pvalueT=0.1,geneExpressionProfile=humanExpr_down,verbose=F)
...
y_upORdown <- geneAnswersBuilder(humanGeneInput_upORdown,"org.Hs.eg.db",categoryType="KEGG",testType="hyperG",pvalueT=0.1,geneExpressionProfile=humanExpr_upORdown,verbose=F)
