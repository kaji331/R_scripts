...
factor(paste(gse_sample$Tissue,gse_sample$Oxygen,sep="."))
...
contrasts.fit(fit,cm) %>>% eBayes %:>% (dif <- topTable(.,coef=c("Cardiac3","Cardiac24","Cardiac48","Lung3","Lung24","Lung48"),number=335))
